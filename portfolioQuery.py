...
class Portfolio:
    ...
    def pickLongPortfolio(self, numAssets):
        ...
        for i in range(100):
            flt,names = self.getLongPortfolioGivenAssetStringAndRf(random.sample(x,numAssets), self.get_si_rate(), 1)
